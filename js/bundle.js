(function () {
	...
	(function(window){
		...
		var Animation=Laya.Animation,AtlasInfoManager=Laya.AtlasInfoManager,Browser=Laya.Browser,ClassUtils=Laya.ClassUtils;
		var Event=Laya.Event,Handler=Laya.Handler,Label=Laya.Label,MouseManager=Laya.MouseManager,Pool=Laya.Pool;
		var Prefab=Laya.Prefab,ResourceVersion=Laya.ResourceVersion,RigidBody=Laya.RigidBody,Scene=Laya.Scene,Script=Laya.Script;
		var SoundManager=Laya.SoundManager,Sprite=Laya.Sprite,Stat=Laya.Stat,Text=Laya.Text,URL=Laya.URL,Utils=Laya.Utils;
		...
		*/
		...
		GameConfig.startScene="scene01.scene";
